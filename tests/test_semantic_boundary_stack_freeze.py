...
MONOREPO_FORMAL_ARTIFACTS_AVAILABLE = (
    BULLA.parent / "papers/interpolant-envelope/lean/InterpolantEnvelope/Boundary.lean"
).is_file()


@pytest.mark.skipif(
    not MONOREPO_FORMAL_ARTIFACTS_AVAILABLE,
    reason="the semantic-boundary freeze binds formal artifacts outside the standalone Bulla subtree",
)
