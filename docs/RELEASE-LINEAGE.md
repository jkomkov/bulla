...
| 0.49.3 | candidate; not published | Documentation and package-metadata patch. Publication is established only by the accepted PyPI artifacts and signed final release evidence, not this preparation row. |
