# Bulla 0.44.5 publication contract
...
The release ships `action-receipt-v0.2-verification-kit.zip` without changing
the normative ActionReceipt v0.2 format. The expected kit SHA-256 is:
...
- [ ] Python 3.10 through 3.13 and Linux/macOS package checks pass for the exact
...
- [ ] The Glyph candidate contains the same kit and detached digest, labels the
      ...
      status.
- [ ] The published-CLI evidence snapshot has been refreshed for Bulla 0.44.5
...
```text
APPROVE BULLA 0.44.5 PUBLICATION
```
...
1. Record the approved public-mirror commit and run the trusted publication
...
5. Update Glyph's published-package evidence to the accepted Bulla 0.44.5
