...
|---|---|---|
| **Wire format** | `action-receipt-v0.N.md` | The receipt shape and canonicalization. `0.1` superseded, **`0.2` normative**, `0.3` opt-in released draft, `0.4` opt-in released experimental draft in Bulla 0.44.2 that does *not* supersede `0.2`. |
